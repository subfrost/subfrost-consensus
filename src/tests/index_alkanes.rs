#[cfg(test)]
mod tests {
    use protorune::balance_sheet::{BalanceSheet, ProtoruneRuneId};
    use protorune::message::MessageContext;
    use protorune::proto::protorune::{RunesByHeightRequest, WalletRequest};

    use protorune::rune_transfer::RuneTransfer;
    use crate::tests::test_helpers as helpers;
    use crate::tests::test_helpers::{display_list_as_hex, display_vec_as_hex};
    use protorune::utils::consensus_encode;
    use protorune::Protorune;
    use protorune::{message::MessageContextParcel, tables, view};
    use anyhow::Result;
    ...
    fn runes_by_height_test() {
        ...
        let runes: Vec<protorune::proto::protorune::Rune> = test_val.clone().runes;
